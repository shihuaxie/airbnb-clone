                ...
                {addedPhotos.length > 0 && addedPhotos.map(link => (
                    <div className="h-32 flex relative" key={link}>
                        ...
                        <button onClick={(e) => removePhoto(e, link)}
                                className="absolute cursor-pointer bottom-1 right-1 text-white bg-black bg-opacity-50 rounded-2xl p-2 px-3">
                        ...
                        <button onClick={(e) => selectAsMainPhoto(e, link)}
                                className="absolute cursor-pointer bottom-1 left-1 text-white bg-black bg-opacity-50 rounded-2xl p-2 px-3">
                            {link === addedPhotos[0] && (
